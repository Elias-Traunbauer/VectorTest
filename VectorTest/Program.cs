...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        public Program()
        {
            ...
            SEUtils.Setup(this, UpdateFrequency.Update10, false);
            var lcd = GridTerminalSystem.GetBlockWithName("TestLCD") as IMyTextPanel;
            var cam = GridTerminalSystem.GetBlockWithName("Camera Test") as IMyCameraBlock;
        }
        ...
        {
            SEUtils.RuntimeUpdate(argument, updateSource);
        }
    }
